...
class SingleStageInstanceSegmentorSam(BaseDetector):
    ...
    def _forward(self,
        ...
        if positive_infos is None:
            ...
            mask_outs = self.mask_head.forward(x, positive_infos, self.image_embeddings)
        outs = outs + (mask_outs, )
        return outs
    ...
    def loss(self, batch_inputs: Tensor, batch_data_samples: SampleList,
        ...
        mask_loss = self.mask_head.loss(
            x, batch_data_samples, positive_infos=positive_infos, image_embeddings=self.image_embeddings, **kwargs)
        # avoid loss override
    ...
    def predict(self,
        ...
        results_list = self.mask_head.predict(
            x, batch_data_samples, rescale=rescale, results_list=results_list, image_embeddings=self.image_embeddings)
