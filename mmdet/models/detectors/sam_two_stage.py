...
class SamTwoStageDetector(BaseDetector):
    ...
    def _forward(self, batch_inputs: Tensor,
        ...
        roi_outs = self.roi_head.forward(x, rpn_results_list,
                                         batch_data_samples, self.image_embedding)
    ...
    def predict(self,
        ...
        results_list = self.roi_head.predict(
            x, rpn_results_list, batch_data_samples, self.image_embedding, rescale=rescale)
