...
from ...necks.CBAM import CBAM
from mmdet.registry import MODELS
from .bbox_head import BBoxHead


@MODELS.register_module()
class AttentionConvFCBBoxHead(BBoxHead):
    ...
    def __init__(self,
        ...
        self.attn = CBAM(self.in_channels)
...
@MODELS.register_module()
class AttentionShared2FCBBoxHead(AttentionConvFCBBoxHead):
...
@MODELS.register_module()
class AttentionShared4Conv1FCBBoxHead(AttentionConvFCBBoxHead):
...
@MODELS.register_module()
class AttentionSep2FCBBoxHead(AttentionConvFCBBoxHead):
