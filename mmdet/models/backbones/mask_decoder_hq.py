...
class MaskDecoderHQ(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.hf_mlp = MLP(transformer_dim, transformer_dim, 4, 3)
    ...
    def forward(
        ...
        masks, iou_pred, box_pred = self.predict_masks(
        ...
        # Prepare output
        return masks, iou_pred, box_pred
    ...
    def predict_masks(
        ...
        for i in range(self.num_mask_tokens):
            if i < self.num_mask_tokens - 1:
                ...
                box_pred = self.hf_mlp(mask_tokens_out[:, i, :])
